...
![Github Robuino](/images/pushbutton.jpg)
...
![Github Robuino](/images/push-button-arduino.png)
...
![Github Robuino](/images/led-with-button.png)

Ο διακόπτης (button) έχει συνδεθεί στην ακίδα 7 του Arduino ενώ το led στην ακίδα 4 
οπότε το σενάριο είναι:

![Github Robuino](/images/button-led.png)
