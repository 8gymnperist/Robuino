...
**--** Η εγκατάσταση λογισμικών απαραίτητων για το προγραμματισμό στο περιβάλλον οπτικού προγραμματισμού Scratch 2.0 με την επέκταση s2aio για τον προγραμματισμό του Arduino
